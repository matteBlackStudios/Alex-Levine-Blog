...
<div id="article-hero" style="background:url(<?= $image ?>);background-size:cover; background-position: center center">
    ...
    <div class="content">
        ...
        <header class="post-info">
            ...
            <span class="comments"><img width="13" height="12"  class="icon" src="<?= get_template_directory_uri() ?>/assets/images/global/comment-icon.png" alt="Comment Shares" /> <?= comments_number('0', '1', '%') ?> </span>
