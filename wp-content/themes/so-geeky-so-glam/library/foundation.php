	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<div class="comment-content content">
			<header class="comment-author">
				...
				<time datetime="<?php echo comment_date( 'c' ) ?>"><i class="fa fa-clock-o" aria-hidden="true"></i> <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf( get_comment_date(), get_comment_time() ) ?></a></time>
			...
			<div class="reply">
				<img src="<?= get_template_directory_uri() ?>/assets/images/global/reply-icon.png" alt="reply icon"/>
